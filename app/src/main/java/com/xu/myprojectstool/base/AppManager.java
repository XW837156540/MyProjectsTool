...
public class AppManager {
    ...
    private static AppManager activityTaskManager = null;
    ...
    public static synchronized AppManager getInstance() {
        if (activityTaskManager == null) {
            activityTaskManager = new AppManager();
        }
    ...
    public void removeActivity(String name) {
        BaseActivity activity = activityMap.remove(name);
     ...
     */
    private final void finisActivity(BaseActivity activity) {
