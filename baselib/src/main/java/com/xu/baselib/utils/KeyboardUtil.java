...
/**
 * Created by zhulang-pc on 2016/6/14.
 * in dync. anyrtc.io
 * 移动控件使得键盘不会挤压整体布局
 */
    ...
    public void observeSoftKeyboard(Activity activity, final OnSoftKeyboardChangeListener listener) {
        ...
        decorView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                int heightDiff = screenHeight - (r.bottom - r.top) - statusBarHeight; //状态栏
                //int heightDiff = screenHeight - (r.bottom - r.top);
                if (keyboardHeight != heightDiff && heightDiff > (screenHeight / 4)) {
                    if (isVKeyMap) {
                ...
                int screenDiff = screenWidth - (r.right - r.left);


                Log.i(TAG, screenDiff + "onGlobalLayout: keyboardHeight-------" + keyboardHeight);
                if (isVKeyMap) {
